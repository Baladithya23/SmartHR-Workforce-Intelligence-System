...
function EditEmployee() {
    ...
    useEffect(() => {
        Promise.all([getEmployeeById(id), getDepartments()])
            .then(([empRes, deptRes]) => {
            ...
            .catch(() => showToast({ type: "error", title: "Load Failed", message: "Could not load employee data." }))
    ...
    function handleSubmit(e) {
        ...
        updateEmployee(id, payload)
            .then(() => {
                showToast({ type: "success", title: "Updated!", message: `${form.employeeName} updated successfully.` });
                setTimeout(() => navigate("/employees"), 1200);
            })
            .catch((err) => {
                const msg = err?.response?.data?.message || "Could not update employee.";
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div className="form-grid">
                        ...
                        <div className="form-group">
                            <label className="form-label" htmlFor="employeeName">Full Name <span className="required">*</span></label>
                        ...
                        <div className="form-group">
                            <label className="form-label" htmlFor="designation">Designation <span className="required">*</span></label>
                        ...
                        <div className="form-group">
                            ...
                            <input id="joiningDate" name="joiningDate" type="date"
                                className="form-input" value={form.joiningDate} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label className="form-label" htmlFor="salary">Monthly Salary (₹) <span className="required">*</span></label>
                    ...
                    <div className="form-actions">
                        ...
                        <button type="submit" className="btn-save" disabled={saving}>
                            {saving ? (<><span className="btn-spinner" /> Updating…</>) : (<>✓ Update Employee</>)}
                        </button>
                    </div>
                </form>
            </div>
